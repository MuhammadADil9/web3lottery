...
contract raffle is VRFConsumerBaseV2Plus {
    ...
    /** Functions */
    constructor(uint256 fee, uint256 time, uint256 subId, bytes32 keyHash, address vrfCordinatorAddress ) VRFConsumerBaseV2Plus(vrfCordinatorAddress)   {
        i_EnteranceFee = fee;
        i_Owner = msg.sender;
        i_timeLimit = time;
    ...
    event amountPaidToWinner(address indexed winnerAddress, string indexed winnerName);
